...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        obstacles.add(new Obstacle(new Vector3d(-2, 0, -0.5), ObstacleType.BOX));
        obstacles.add(new Obstacle(new Vector3d(-2, 0, -1), ObstacleType.BOX));
        obstacles.add(new Obstacle(new Vector3d(-2, 0, 0), ObstacleType.BOX));
        obstacles.add(new Obstacle(new Vector3d(-2, 0, 0.5), ObstacleType.BOX));
        obstacles.add(new Obstacle(new Vector3d(-2, 0, 1), ObstacleType.BOX));
        obstacles.add(new Obstacle(new Vector3d(-2, 0, 1.5), ObstacleType.BOX));
        ...
        obstacles.add(new Obstacle(new Vector3d(0, 0, -1), ObstacleType.BOX));
        obstacles.add(new Obstacle(new Vector3d(0.5, 0, -1), ObstacleType.BOX));
        ...
        path.add(new PathLine(new Vector3d(-7.5, 0, 0), 4, true));
